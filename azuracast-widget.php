...
class Azuracast_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        __( 'Azuracast: Now Playing', 'azurawidget' ),
        array(
    ...
    public function form( $instance ) {
        ...
        <?php // Widget Title ?>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Titel', 'azurawidget' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
            </p>

        <?php // Text Field ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'azuracast_instanz' ) ); ?>"><?php _e( 'Azuracast', 'azurawidget' ); ?></label>
        ...
        <?php // Webplayer Link ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'own_player_link' ) ); ?>"><?php _e( 'Eigener Player Link', 'azurawidget' ); ?></label>
        ...
        <?php // Own Player Link ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'webplayer_link' ) ); ?>"><?php _e( 'Webplayer Link', 'azurawidget' ); ?></label>
        ...
        <?php // Station ID ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'station_id' ) ); ?>"><?php _e( 'Station ID', 'azurawidget' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_cover' ) ); ?>"><?php _e( 'Cover anzeigen', 'azurawidget' ); ?></label>
            <br>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_track' ) ); ?>"><?php _e( 'Track anzeigen', 'azurawidget' ); ?></label>
            <br>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_artist' ) ); ?>"><?php _e( 'Künstler anzeigen', 'azurawidget' ); ?></label>
            <br>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_album' ) ); ?>"><?php _e( 'Album anzeigen', 'azurawidget' ); ?></label>
            <br>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'webplayer_btn' ) ); ?>"><?php _e( 'Webplayer Button anzeigen', 'azurawidget' ); ?></label>
            <br>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'own_player_btn' ) ); ?>"><?php _e( 'Eigener Player Button anzeigen', 'azurawidget' ); ?></label>
        </p>
    <?php 
    }
            ...
            ?>
                ...
                <div class="acnp_cta">
                    ...
                    if($webplayer_btn == true) {
                        echo '<input type="button" value="'.translate( 'Webplayer', 'azurawidget' ).'" onclick="window.open(\''.$webplayer_link.'\');" />';
                    }
                    if($own_player_btn == true) {
                        echo '<input type="button" value="'.translate( 'Eigener Player', 'azurawidget' ).'"  onclick="window.open(\''.$own_player_link.'\');" />';
                    }
                    ?>
                </div>
            </div>
